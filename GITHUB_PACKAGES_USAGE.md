...
kotlin {
    sourceSets {
        val commonMain by getting {
            dependencies {
                implementation("org.hyperledger.identus:sdk:3.0.0-fork.18.1")
            }
        }
    }
}
...
```kotlin
dependencies {
    implementation("org.hyperledger.identus:sdk-android-release:3.0.0-fork.18.1")
    // 或者使用 debug 版本
