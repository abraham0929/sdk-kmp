...
kotlin {
    sourceSets {
        val commonMain by getting {
            dependencies {
                implementation("org.hyperledger.identus:sdk:3.0.0-fork.18.16")
            }
        }
    }
}
...
```kotlin
dependencies {
    implementation("org.hyperledger.identus:sdk-android-release:3.0.0-fork.18.16")
    // 或者使用 debug 版本
    // implementation("org.hyperledger.identus:sdk-android-debug:3.0.0-fork.16")
}
```
...
```kotlin
dependencies {
    implementation("org.hyperledger.identus:sdk-jvm:3.0.0-fork.18.1")
}
```
